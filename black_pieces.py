...
class BlackPieces():
    def __init__(self, screen, settings,board):
        ...
        # Make the bishops.
        self.bishop_1 = Bishop(screen, settings, board, x=2, y=0)
        self.bishop_2 = Bishop(screen, settings, board, x=5, y=0)
        # Make the knights.
        self.knight_1 = Knight(screen, settings, board, x=1, y=0)
        self.knight_2 = Knight(screen, settings, board, x=6, y=0)
        # Make the rooks.
        self.rook_1 = Rook(screen, settings, board, x=0, y=0)
        self.rook_2 = Rook(screen, settings, board, x=7, y=0)
        # Make the pawns.
        self.Pawn_1 = Pawn(screen, settings, board, x=0, y=1)
        self.Pawn_2 = Pawn(screen, settings, board, x=1, y=1)
        self.Pawn_3 = Pawn(screen, settings, board, x=2, y=1)
        self.Pawn_4 = Pawn(screen, settings, board, x=3, y=1)
        self.Pawn_5 = Pawn(screen, settings, board, x=4, y=1)
        self.Pawn_6 = Pawn(screen, settings, board, x=5, y=1)
        self.Pawn_7 = Pawn(screen, settings, board, x=6, y=1)
        self.Pawn_8 = Pawn(screen, settings, board, x=7, y=1)
        # the promoting pawn.
        ...
        self.pieces = [
                        ...
                        self.rook_1, self.rook_2, self.Pawn_1, self.Pawn_2, self.Pawn_3, self.Pawn_4,
                        self.Pawn_5, self.Pawn_6, self.Pawn_7, self.Pawn_8
                      ]
