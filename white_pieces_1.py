...
class WhitePieces():
    def __init__(self, screen, settings,board):
        ...
        self.Pawn_6 = Pawn(screen, settings, board, x=2, y=6, color="white")
        self.rook_2 = Rook(screen, settings, board, x=7, y=7, color="white")
        self.bishop_2 = Bishop(screen, settings, board, x=2, y=7, color="white")
        
        self.knight_1 = Knight(screen, settings, board, x=1, y=7, color="white")
        self.Pawn_7 = Pawn(screen, settings, board, x=1, y=6, color="white")
        self.Pawn_8 = Pawn(screen, settings, board, x=0, y=6, color="white")
        # the promoting pawn.
        self.promoting_pawn = None
        # Putting the black pieces in a list to easly manupilate them
        self.pieces = [
                        self.king, self.queen, self.Pawn_6, self.bishop_2, self.rook_2, self.Pawn_7, self.Pawn_8, self.knight_1
                      ]
